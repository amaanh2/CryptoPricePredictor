...
from ema_cross.dos_ind_cart_funcs import get_cur_ind_set_tuple, get_og_ind_and_dos_tuples
from ema_cross.helper_class import StratHelpers
from ema_cross.plotting_funcs import plotting_signals
from ema_cross.tuples_and_variables import(
    IndicatorSettings,
    static_os_tuple,
