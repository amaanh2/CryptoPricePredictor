...
from ema_cross.tuples_and_variables import IndicatorSettings, dos_tuple
...
def get_og_ind_and_dos_tuples(
    ...
    cart_prod_array, total_order_settings = og_strat.get_ind_set_dos_cart_product(
        dos_tuple=dos_tuple,
        ind_set_tuple=ind_set_tuple,   
    )

    filtered_cart_prod_array, total_indicator_settings = get_filter_cart_product_array(
    ...
    return og_dos_tuple, og_ind_set_tuple, 1, total_indicator_settings
...
def get_filter_cart_product_array(
